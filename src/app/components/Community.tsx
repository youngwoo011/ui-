...
export function Community() {
  ...
  const filteredCommunities = communities.filter((community) => {
    ...
    if (selectedTab === "club") return community.category === "동호회";
    if (selectedTab === "study") return community.category === "스터디";
    if (selectedTab === "activity") return community.category === "사내활동";
    return true;
  });
