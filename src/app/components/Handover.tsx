...
export function Handover() {
  ...
  const givingHandovers: Handover[] = [
    {
      id: 4,
      title: "마케팅 캠페인 업무 인계",
      from: "홍길동",
  ...
  const getStatusBadge = (status: Handover["status"]) => {
    const configs = {
  ...
  const HandoverCard = ({ handover }: { handover: Handover }) => (
          ...
          <CardContent>
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="content"
                  placeholder="인수인계할 내용을 상세히 작성하세요..."
                  rows={6}
                />
              </div>
